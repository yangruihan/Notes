...
- 模式
	...
	13. [适配器模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/adapter_pattern)
	
	14. [备忘录模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/memento_pattern)
	
	15. [组合模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/composite_pattern)
	
	16. [迭代器模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/iterator_pattern)
	
	17. [单例模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/singleton_pattern)
	
	18. [桥接模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/bridge_pattern)
	
	19. [命令模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/command_pattern)
	
	20. [职责链模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/chain_of_responsibility_pattern)
	
	21. [中介者模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/mediator_pattern)
	
	22. [享元模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/flyweight_pattern)
	
	23. [解释器模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/interpreter_pattern)
	
	24. [访问者模式](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/pattern/visitor_pattern)
...
- 原则
	...
	6. [合成/聚合复用原则](https://github.com/yangruihan/Notes/tree/master/DesignPattern/src/com/yrh/principle/CARP)